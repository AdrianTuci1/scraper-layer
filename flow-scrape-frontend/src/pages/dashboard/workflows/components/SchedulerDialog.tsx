...
function SchedulerDialog({
  ...
  const { setCron: updateCron, removeCron, isSettingCron, isRemovingCron } =
    useWorkflows();
  ...
  const readableWorkflowCron =
    hasValidCron && cronstrue.toString(workflowCron);
      ...
      <DialogContent className="px-0">
          ...
          <DialogClose asChild>
            <div className="px-8">
              <Button
                ...
                variant={'outline'}
                disabled={isSettingCron || isRemovingCron}
        ...
        <DialogFooter className="px-6 gap-2">
          ...
          <DialogClose asChild>
            <Button
              className="w-full"
              disabled={!validCron || isSettingCron || !cron}
              onClick={handleSave}
            >
              Save
            </Button>
