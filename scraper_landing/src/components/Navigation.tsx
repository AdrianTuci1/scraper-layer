          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
            ...
            <div className="relative" ref={languageRef}>
              <button
                ...
                className="flex items-center space-x-1 px-3 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors duration-200"
              >
                ...
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="py-1">
                    ...
                    <button
                      ...
                      className={`block w-full text-left px-4 py-2 text-sm ${
                        i18n.language === 'ro' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
                      }`}
                    >
                      {t('language.romanian')}
                    </button>
